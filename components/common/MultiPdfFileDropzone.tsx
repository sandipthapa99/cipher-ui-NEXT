    ...
    return (
        <Field name={name}>
            {({ form }: FieldProps) => {
                const pdfFile =
                    pdfPreview &&
                    form.values[pdfPreview]?.map((val: any) => {
                        return {
                ...
                const isPreviewImage =
                    pdfPreview && form.values[pdfPreview]?.length;
                        ...
                        >
                            ...
                            <Dropzone
                                ...
                                onDrop={(files) => {
                                    ...
                                    pdfPreview &&
                                        form.setFieldValue(pdfPreview, [
                                            ...form.values[pdfPreview],
                                            ...multipleFiles,
                                        ]);
                                }}
                                onReject={(files) => {
...
export default MultiPdfFileDropzone;
