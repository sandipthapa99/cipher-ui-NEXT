    ...
    <div className='user-task-card'>
      <div className='user-task-card__header'>
        ...
        <div className='user-info'>
          ...
          <span>
            <span className='user-info__category'>{task.user.category}</span>
            <span> | </span>
            <span>{task.user.location}</span>
          </span>
          <div className='user-ratings'>
            <div className='d-flex align-items-center'>
              <FontAwesomeIcon color='#FAB005' className='svg-icon' icon={faStar} />
              <span>{task.rating.average}</span>
              <span>{`(${task.rating.totalRatings})`}</span>
            </div>
            <div className='d-flex align-items-center'>
              <FontAwesomeIcon color='#F98900' className='svg-icon' icon={faSmile} />
        ...
        <FontAwesomeIcon className='svg-icon' icon={faEllipsisVertical} />
      </div>
      <p className='user-info__bio'>
        {task.user.bio}
      </p>
      <div className='user-task-card__footer'>
        <FontAwesomeIcon color='#FE5050' className='svg-icon' icon={faHeart} />
        <FontAwesomeIcon color='#3EAEFF' className='svg-icon' icon={faShare} />
