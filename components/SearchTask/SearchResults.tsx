...
import {
  ServiceNearYou,
  servicesNearYou,
} from '../../staticData/servicesNearYouCard'
import ServiceNearYouCard from './searchAside'

interface SearchResultsProps {
  sevicesNearYou: ServiceNearYou[]
}

const SearchResults = ({ sevicesNearYou }: SearchResultsProps) => {
      ...
      <Row>
        <Col md={4} style={{ overflowY: 'scroll', maxHeight: '175vh' }}>
          <p style={{ fontSize: '12px', color: '#495057', lineHeight: '18px' }}>
            {servicesNearYou.length} Services in Kathmandu, Nepal (1 new)
          </p>
          {renderServiceCards()}
        </Col>
