import { faBars, faTelescope, faListCheck, faObjectsColumn, faLocationDot, faAngleDown } from "@fortawesome/pro-regular-svg-icons";
...
const Header = () => {
    ...
    return (
        ...
        <header
                id="site-header"
                className={`site-header ${stickyClass}`}
            >
                <Container className="">
                            ...
                            <li className={handleMenuActive("/how-it-works", router)}>
                                    <Link href="/">
                                        <a className="nav-link">
                                            <FontAwesomeIcon icon={faTelescope} className="svg-icon d-none d-sm-inline-block"/>
                                            Explore Services
                                        </a>
                                    </Link>
                                </li>
                                <li className={handleMenuActive(
                                    ...
                                    <Link href="/resources">
                                        <a className="nav-link">
                                            <FontAwesomeIcon icon={faListCheck} className="svg-icon d-none d-sm-inline-block"/>
                                            Find Tasks
                                        </a>
                                    </Link>
                                </li>
                                <li className={handleMenuActive(
                                    ...
                                    <Link href="/resources">
                                        <a className="nav-link">
                                            <FontAwesomeIcon icon={faUserHelmetSafety} className="svg-icon d-none d-sm-inline-block"/>
                                            Find Merchants
                                        </a>
                                    </Link>
                                </li>
                                <li className={handleMenuActive(
                                    ...
                                    <Link href="/resources">
                                        <a className="nav-link d-none d-md-inline-block">
                                            <FontAwesomeIcon icon={faObjectsColumn} className="svg-icon"/>
                                            Categories
                                            <FontAwesomeIcon icon={faAngleDown} className="faAngleDown-svg-icon"/>
                                        </a>
                                    </Link>
                                </li>
                            </nav>
