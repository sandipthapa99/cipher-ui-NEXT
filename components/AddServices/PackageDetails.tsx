...
export const PackageDetails = ({handlePrev, handleNext}: PackageDetailsProps) => {
          ...
          <Row>
            <Col md={7} sm={12}>
              <div className="service-form-body">
                <Formik initialValues={packageDetailsData} onSubmit={() => {}}>
                  {({ errors, touched }) => (
                    <>
                      <Form>
                        ...
                        <h6>Add services which you Offer</h6>
                        <InputField
                          name="package_price"
                          labelName="Price"
                          placeHolder="Price"
