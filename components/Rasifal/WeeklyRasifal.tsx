...
export const WeeklyRasifal = () => {
    const [weeklyRasifal, setWeeklyRasifal] = useState<Rasifal[]>([]);
    const [heading, setHeading] = useState("");

    const url = "https://www.hamropatro.com/rashifal/weekly";
        ...
        axios.get(url).then((response) => {
            ...
            $(".item").each(function (index, element) {
                ...
                axios.get(insideUrl).then((response) => {
                    ...
                    setWeeklyRasifal((pevWeeklyRasifal) => [
                        ...pevWeeklyRasifal,
